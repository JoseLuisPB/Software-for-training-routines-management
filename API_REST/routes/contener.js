...
router.get("/sumaSeries/:dni/:codigoActividad/:fechaInicio/:fechaFin", contener.sumaSeries);
router.get("/sumaRepeticiones/:dni/:codigoActividad/:fechaInicio/:fechaFin", contener.sumaRepeticiones);
